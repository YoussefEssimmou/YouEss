...
zip_path = "D:/FPO/IAA/S2/Apprentissage profond/TPs/TP7/amhcd-data-64.zip"
extract_dir = "D:/FPO/IAA/S2/Apprentissage profond/TPs/TP7/amhcd-data-64/amhcd-data-64/tifinagh-images/amhcd-data-64/tifinagh-images"
...
def visualize_feature_maps(model, data_loader, device, num_images=4):
    ...
    for layer_name, fmaps in feature_maps.items():
        ...
        nrows = 2 if num_filters > 8 else 1
...
if __name__ == "__main__":
    # Configuration
    DATA_DIR = "D:/FPO/IAA/S2/Apprentissage profond/TPs/TP7/amhcd-data-64/amhcd-data-64/tifinagh-images/amhcd-data-64/tifinagh-images" 
    BATCH_SIZE = 64
    NUM_EPOCHS = 50
    LEARNING_RATE = 0.001
